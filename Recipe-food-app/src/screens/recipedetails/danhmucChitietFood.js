...
import { AlarmAddOutlined, BookmarkBorderOutlined, ForumOutlined, LocalFireDepartmentOutlined, StarBorderOutlined, ThumbUpOutlined } from "@mui/icons-material";
        ...
        <View style={styles.v11}>
          ...
          <View style={styles.star}>
            <View style={styles.viewdg}>
              <AlarmAddOutlined fontSize="large"/>
              <Text style={styles.tdg}>{item.min} min</Text>
            </View>
            <View style={styles.viewdg}>
              <LocalFireDepartmentOutlined fontSize="large" color="error"/>
              <Text style={styles.tdg}>{item.kcal} Kcal</Text>
            </View>

            <View style={styles.viewdg}>
             <StarBorderOutlined fontSize="large" color="warning"/>
...
const styles = StyleSheet.create({
  ...
  viewdg: {
    ...
    alignItems: "center",
    justifyContent: "space-between",
    //paddingHorizontal: 10, // điều chỉnh giá trị này để tăng khoảng cách
  },
  tdg: {
    fontSize: 15,
    fontWeight: "400",
